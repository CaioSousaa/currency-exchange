...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "border-border/50 bg-background grid w-40 gap-1.5 rounded-md border px-2.5 py-1.5 text-xs shadow-xl",
        className
      )}
    >
        ...
        {payload.map((item, index) => {
          ...
          return (
            <div
              key={item.dataKey}
              className={cn(
                "flex w-full flex-wrap text-zinc-200 items-stretch gap-2 ",
